...
::: columns
::: {.column width="30%"}
<!-- !![](resources/ya.jpg) --> TODO: add photo
:::
...
[Gitter Chat Channel](https://matrix.to/#/#workshop-r-swe-sf:matrix.org)
[](resources/workshop-gitter-chat-channel.png)
...
TODO: need to update the qr code and the link

[](resources/workshop-mentimeter.png)

##  {background-iframe="https://www.mentimeter.com/app/presentation/aljjjxmphsrgrg1z92ynw2mqeysduryr/embed" background-interactive="true"}
