...
-   Developer of the open-source [`psborrow2` R package](https://github.com/Genentech/psborrow2) for Bayesian dynamic borrowing analyses as well as internal Roche packages
...
-   We have a gitter channel for this course that you can connect to
