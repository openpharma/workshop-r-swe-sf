...
This is an opportunity to anticipate your user's problems. You may 
prioritize the biggest errors with custom messages. (**Remember**: 
`checkmate` can also be useful in drafting error messages).
...
-   In the current version, changes were done by (later authors): Matt Secrest [`r fontawesome::fa("github")`](https://github.com/mattsecrest/)
