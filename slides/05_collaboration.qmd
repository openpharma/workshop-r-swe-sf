...
## Enter git {{< fa brands github >}} the 'Latin of data science'
...
- **git platforms add UI for collaboration**^[All platforms also available on-premise for enterprise use]
    - [GitHub.com](https://github.com) de facto standard in R (alternative: [GitLab.com](https://gitlab.com/), [BitBucket.org](https://bitbucket.org/), [Gitee.com](https://gitee.com/))
- git + GitHub
  - VCS (git)
...
- Creators (initial authors): 
  Kevin Kunzmann [{{< fa brands github >}}](https://github.com/kkmann/),
  Shuang Li [{{< fa brands github >}}](https://github.com/shuangli22)
